...
snarkjs zkey export verificationkey bonus_circuit_final.zkey verification_key.json

# generate solidity contract
snarkjs zkey export solidityverifier bonus_circuit_final.zkey ../Minesweeper.sol
